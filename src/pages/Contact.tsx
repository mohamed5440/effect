  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (error?.issues?.[0]?.message) {
        ...
        setShowError(error.message || "حدث خطأ أثناء إرسال الرسالة. يرجى المحاولة مرة أخرى.");
      }
    } finally {
      setIsSubmitting(false);
    }
                ...
                <div className="p-6 border-t border-white/5 bg-black/20 backdrop-blur-xl relative z-20 flex flex-col gap-5">
                  <div className="flex items-center justify-between px-1">
                    ...
                    <div className="flex gap-1 bg-white/5 p-1 rounded-lg border border-white/10">
                      ...
                      <button onClick={() => navigate('/contact')} className="px-3 py-1.5 rounded-md bg-transparent text-white/40 font-bold text-xs flex items-center justify-center hover:text-white transition-all">
                        EN
                      </button>
                    </div>
                  </div>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-4 md:pt-36 md:pb-8">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="section-subtitle mb-0">تواصل معنا</span>
            <div className="w-10 h-[2px] bg-white/10 rounded-full relative overflow-hidden">
              <motion.div 
                animate={{ x: ["-100%", "200%"] }}
          ...
          <h1 className="section-title">نحن هنا <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">لسماعك</span></h1>
          <p className="text-white/50 text-sm md:text-lg max-w-2xl mx-auto font-light leading-relaxed">هل لديك استفسار أو تود بدء مشروع جديد؟ املأ النموذج أدناه وسيقوم فريقنا بالرد عليك في أقرب وقت.</p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-xs text-white/40 mr-11">أدخل بياناتك لنتمكن من الرد على رسالتك.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-white/60 uppercase mr-1">الموضوع</label>
                <div className="relative group">
                  <Info size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-accent transition-colors" />
                  <input type="text" name="subject" required placeholder="ما هو موضوع رسالتك؟" className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 px-12 text-white placeholder:text-white/20 focus:outline-none focus:border-accent/50 focus:bg-white/10 transition-all" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-xs text-white/40 mr-11">اكتب تفاصيل استفسارك أو مشروعك هنا.</p>
            </div>

            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold text-white/60 uppercase mr-1">نص الرسالة</label>
              <div className="relative group">
                <MessageSquare size={18} className="absolute right-4 top-4 text-white/20 group-focus-within:text-accent transition-colors" />
                <textarea name="message" required placeholder="كيف يمكننا مساعدتك؟" rows={6} className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 px-12 text-white placeholder:text-white/20 focus:outline-none focus:border-accent/50 focus:bg-white/10 transition-all resize-none"></textarea>
              </div>
            </div>
          </div>
        ...
        {showSuccess && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            >
              ...
              <p className="text-white/50 mb-8 leading-relaxed">شكراً لتواصلك مع إيفيكت ميديا. لقد استلمنا رسالتك وسيقوم فريقنا بالرد عليك في أقرب وقت ممكن.</p>
              <button 
                onClick={() => {
                  setShowSuccess(false);
                  window.scrollTo(0, 0);
