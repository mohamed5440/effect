...
export default function Home() {
  ...
  const services = [
    { id: "01", title: "التسويق الرقمي", desc: "إعلانات جوجل وجميع المنصات لتحقيق أقصى وصول.", icon: <Megaphone size={24} /> },
    { id: "02", title: "إدارة واستراتيجيات السوشيال ميديا", desc: "استراتيجيات محتوى وتفاعل تبني مجتمعاً حول علامتك.", icon: <Smartphone size={24} /> },
    { id: "03", title: "التصميم الإبداعي", desc: "بناء الهوية البصرية التي تعبر عن جوهر مشروعك.", icon: <PenTool size={24} /> },
    { id: "04", title: "إنتاج وتحرير الفيديو", desc: "محتوى مرئي جذاب يروي قصتك بأسلوب سينمائي.", icon: <Clapperboard size={24} /> },
    { id: "05", title: "تصميم وتطوير المواقع", desc: "تصميم وتطوير مواقع سريعة ومتجاوبة تعزز تجربة المستخدم.", icon: <MonitorSmartphone size={24} /> },
    { id: "06", title: "البرمجة والحلول التقنية المخصصة", desc: "برمجة مخصصة وحلول تقنية ذكية لتطوير أعمالك.", icon: <Terminal size={24} /> },
  ];
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-accent selection:text-black text-right bg-deep-black overflow-x-hidden" dir="rtl">
      {/* Navigation */}
      <motion.nav 
        style={{ 
      ...
      >
        ...
        <div className="flex items-center z-10">
          <button onClick={() => scrollToSection('contact')} className="bg-white text-black px-4 py-2 md:px-8 md:py-4 rounded-full font-bold text-[10px] md:text-sm uppercase flex items-center gap-1.5 md:gap-2 hover:bg-accent hover:text-white transition-all group">
            <span className="hidden sm:block">تواصل معنا</span>
                      ...
                      {[
                        ...
                        return (
                          ...
                          >
                            ...
                            <ArrowUpRight size={16} className={`mr-auto transition-all duration-500 ${isActive ? "text-accent opacity-100" : "text-white/20 opacity-0 group-hover:opacity-100 group-hover:translate-x-[-4px]"}`} />
                          </motion.button>
                        );
                      })}
                    </motion.div>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-20 overflow-hidden bg-deep-black">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center text-center pt-6 px-4">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[5rem] font-extrabold text-white leading-[1.2] lg:leading-[1.1] mb-6 max-w-4xl tracking-tight">
              حول أفكارك إلى <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">نجاح رقمي</span> معنا!
            </h1>

            <p className="text-base md:text-xl text-white/80 max-w-2xl mb-6 leading-relaxed font-light">
              نحن شريكك في تصميم المنتجات، إنشاء المواقع، وبناء العلامات التجارية لكل مرحلة من مراحل عملك.
            </p>
        ...
        >
          <span className="text-[10px] font-bold uppercase text-white/30 group-hover:text-accent transition-colors duration-300">تمرير</span>
          ...
          <div className="flex flex-col items-center">
            ...
            >
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="section-subtitle mb-0">من نحن</span>
                <div className="w-10 h-[2px] bg-white/10 rounded-full relative overflow-hidden">
                  <motion.div 
                    animate={{ x: ["-100%", "200%"] }}
              ...
              <h2 className="section-title leading-[1.2] text-center">
                نحن لا نواكب المستقبل، <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">نحن نصنعه.</span>
              </h2>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-4 md:mb-6 gap-4 md:gap-6">
            <div className="flex flex-col gap-3 md:gap-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="section-subtitle mb-0">خدماتنا</span>
              </div>
              <h2 className="section-title">ماذا <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">نقدم؟</span></h2>
            </div>
            <p className="max-w-sm text-white/50 text-sm md:text-base font-light leading-relaxed">
              حلول رقمية متكاملة مصممة خصيصاً لتنمية أعمالك وتعظيم حضورك الرقمي.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-4 md:mb-6 flex flex-col items-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="section-subtitle mb-0">الباقات</span>
              <div className="w-10 h-[2px] bg-white/10 rounded-full relative overflow-hidden">
                <motion.div 
                  animate={{ x: ["-100%", "200%"] }}
                  transition={{ duration: 2, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
            ...
            <h2 className="section-title">مستويات <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">الخدمة</span></h2>
            <p className="text-sm md:text-base text-white/50 max-w-xl mx-auto font-light">نقدم حلولاً مرنة تناسب ميزانيتك ومرحلة مشروعك</p>
          </div>
            ...
            {levels.map((level, i) => (
              ...
              >
                ...
                <div className="flex items-center justify-between relative z-10">
                  ...
                  <span className="text-accent font-bold text-xs md:text-sm uppercase bg-accent/10 px-4 py-2 rounded-2xl border border-accent/20 group-hover:bg-accent group-hover:text-black transition-colors">{level.level}</span>
                </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    { name: "مستويات الخدمة", id: "pricing" },
                    { name: "انضم إلينا", id: "/join", isRoute: true }
                  ].map(link => (
                    <button 
                      key={link.name} 
                      onClick={() => link.isRoute ? navigate('/ar' + link.id) : scrollToSection(link.id)} 
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  {["التسويق الرقمي", "إدارة السوشيال ميديا", "التصميم الإبداعي", "تطوير المواقع"].map(link => (
                    <button key={link} onClick={() => scrollToSection('services')} className="text-sm md:text-base font-medium text-white/60 hover:text-white hover:translate-x-[-4px] transition-all w-fit text-right">{link}</button>
                  ))}
                </div>
              </div>
            </div>
